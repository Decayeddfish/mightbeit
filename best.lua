...
local repo = 'https://raw.githubusercontent.com/Luarmorscripts/library/fc2cdf27b6e7eeb1701d4028faf1757b09b6f4ba'

local Library = loadstring(game:HttpGet(repo .. '/main'))()
local ThemeManager = loadstring(game:HttpGet(repo .. '/themes'))()
local SaveManager = loadstring(game:HttpGet(repo .. '/save'))()

Library:Notify('Failurty Loading')
wait(1)
...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Failurty.CC | %s fps | %s ms | Time: %s'):format(
        math.floor(FPS),
